                                ...
                                <tbody>
                                    ...
                                    if ($product_result->num_rows > 0) {
                                        while ($product_row = $product_result->fetch_assoc()) {
                                            ...
                                            echo "<td>" . htmlspecialchars($product_row["product_description"]) . "</td>";
                                            echo "<td>₱" . number_format($product_price, 2) . "</td>";
                                            echo "<td><img src='" . htmlspecialchars($product_row["image"]) . "' alt='Product Image' style='max-width: 100px; height: auto;'></td>";
                                                        ...
                                                        <form method="POST" action="" enctype="multipart/form-data">
                                                            <div class="modal-body">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <img src="'.$product_row['image'].'" alt="Current Image" style="max-width: 100px; margin-top: 10px;">
                                                                </div>
                                                            </div>
                                        ...
                                        echo "<tr><td colspan='6'>No products submitted.</td></tr>";
                                    }
                                    ?>
                                </tbody>
                            </table>
